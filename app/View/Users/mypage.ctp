                 ...
                 <?php 
					...
					?>
						  <div class="performer-info">
							  ...
							  <a onClick="return fnartistmediatitle(<?php echo $usermedia_id;?>);" id="<?php echo $usermedia_id;?>" class="artistmediatitle">
							   <?php echo $count;?>
							  </a>
								 </div>
								 ...
								 <div class="col-md-9">
									<div class="row">
										<a  id="<?php echo  $usermedia_id;?>"  onClick="return fnartistmediatitle(<?php echo $usermedia_id;?>);" class="artistmediatitle" ><?php echo  $usermedia_name;?></a>
									 </div>
								 </div>
