    ...
    <div class="invoice_view">
                ...
                <div class="header">
                    ...
                    <div class="header_cont">
						<div class="left_cont">
							<b><?php echo $arrInvoiceVehicleData[0]['wcz_users']['user_fname']; ?></b><br />
				...
				<table id="invoice_table">
                	<tr class="alt-headrow">
                        ...
                        <tr class="alt-amountrow">
                            <td colspan="4">Sales Tax (1.875%)</td>
							<?php $salestax = round(($arrInvoiceVehicleData[0]['wcz_sale']['actual_saleprice'] * 1.875)/100); ?>
                            <td><?php echo $salestax; ?></td>
                        </tr>
						<tr class="alt-amountrow">
                            ...
                            <td id="adjustment_input">
								<?php $adjustment_amount = $arrInvoiceVehicleData[0]['wcz_sale']['adjustment_amt']; 
									...
									{
								?>
									<input type="text" name="adjustment_amt" id="adjustment_amt" value="<?php echo $adjustment_amount; ?>" onChange="return calculate_adjustment();"/>
							  <?php } ?>
							</td>
                        </tr>
						<tr class="alt-amountrow">
                        ...
                        <tr class="alt-amountrow">
							...
							<?php 	$getadjustment_amt = $arrInvoiceVehicleData[0]['wcz_sale']['adjustment_amt'];
									$actual_saleprice = ($arrInvoiceVehicleData[0]['wcz_sale']['actual_saleprice'] + $salestax);
									
									$action = substr($getadjustment_amt,0,1);
									$adjustment_amt = substr($getadjustment_amt,1);
									
									if($action == "+")
									{ $total_amt = $actual_saleprice + $adjustment_amt; }
									else
									{ $total_amt = $actual_saleprice - $adjustment_amt; }
							?>
...
<script type="text/javascript">
	...
	function calculate_balance(get_totalpaid){
		...
		var total_amount = $('#virtual_total_amount').html();
		var balance = "";
	...
	function calculate_adjustment(){
			...
			if(getadjustment_amt != "")
			{
				...
				if(action_symbol =="+")
				{
					...
					$('#virtual_total_amount').html(new_total_amount);
	...
	function adjustment(get_action){
		...
		{ sign = "-"; }
		document.getElementById("adjustment_input").innerHTML = '<input type="text" name="adjustment_amt" id="adjustment_amt" value="'+sign+'" class="form-input" onblur="return calculate_adjustment();"/>';
		return false;
	}
