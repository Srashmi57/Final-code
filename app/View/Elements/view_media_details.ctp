...
{?> onClick="javascript:bootbox.alert('You need to login, to give comment');" <?php } else{ echo "style='cursor:none;'";}?>><img src="<?php echo Router::url('/',true)?>images/chat-icon.png" alt="..."></a>
