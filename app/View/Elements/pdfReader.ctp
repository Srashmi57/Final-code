...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    ...
    <title>Web PDF Viewer 9lessons.info</title>


<link rel="stylesheet" href="<?php echo Router::url('/', true);?>css/viewer.css"/>
<script type="text/javascript" src="<?php echo Router::url('/', true);?>js/compatibility.js"></script>

<!-- This snippet is used in production, see Makefile -->

<script type="text/javascript" src="<?php echo Router::url('/', true);?>js/l10n.js"></script>
<script type="text/javascript" src="<?php echo Router::url('/', true);?>build/pdf.js"></script>
<script type="text/javascript" src="<?php echo Router::url('/', true);?>js/debugger.js"></script>
<script type="text/javascript" src="<?php echo Router::url('/', true);?>js/viewer.js"></script>
